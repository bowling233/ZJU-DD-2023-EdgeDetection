...
#
# Script generated by Vivado on Sat Dec 30 21:29:04 CST 2023
# SW Build 4029153 on Fri Oct 13 20:13:54 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : Graying_0.sh
...
#
# Usage        : Graying_0.sh
#                Graying_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Graying_0.sh [-reset_run]
#                Graying_0.sh [-reset_log]
#                Graying_0.sh [-help]
#
...
#                script (type 'Graying_0.sh -help' for more information).
#
...
design_libs_elab="-libname xbip_utils_v3_0_11 -libname xbip_pipe_v3_0_7 -libname xbip_bram18k_v3_0_7 -libname mult_gen_v12_0_19 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"
...
# script info
echo -e "Graying_0.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Graying_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.Graying_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.Graying_0 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log Graying_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./Graying_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: Graying_0.sh [-help]\n\
Usage: Graying_0.sh [-step]\n\
Usage: Graying_0.sh [-lib_map_path]\n\
Usage: Graying_0.sh [-reset_run]\n\
Usage: Graying_0.sh [-reset_log]\n\
Usage: Graying_0.sh [-keep_index]\n\
Usage: Graying_0.sh [-noclean_files]\n\n\
